...
def launch_setup(context, *args, **kwargs):
    ...
    # print("gripper_max_velocity:", gripper_max_velocity)
    # print("gripper_max_force:", gripper_max_force)
    # print("launch_rviz:", launch_rviz)
    # print("use_sim_time:", use_sim_time)
    # print("use_internal_bus_gripper_comm:", use_internal_bus_gripper_comm)
